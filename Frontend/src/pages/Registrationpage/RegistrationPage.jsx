          ...
          <form onSubmit={handleSubmit} className="rp-form" noValidate>
            ...
            <div className="rp-row-2">
              ...
              <div className="fg">
                ...
                <div
                  className={`slot-trigger-btn has-slot ${errors.demoSlot && touched.demoSlot ? 'has-error' : ''}`}
                  style={{ cursor: 'default' }}
                >
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                  <span className="slot-filled-text">
                    {formData.demoSlot}
                  </span>
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{width:14,height:14,opacity:.6}}><polyline points="6 9 12 15 18 9"/></svg>
                </div>
